...
<%--            <th>Age</th>--%>
<%--        </tr>--%>
<%--        &lt;%&ndash;<a href="/customers?action=create" style="margin-right: 20px">Tạo Mới</a> <br>&ndash;%&gt;--%>
<%--        &lt;%&ndash;<a href="/customers?action=search">Tìm Kiếm</a>&ndash;%&gt;--%>
...
<%--                </td>--%>
<%--            </tr>--%>
<%--            &lt;%&ndash;    <h2>${customer.id},${customer.name}, ${customer.age}&ndash;%&gt;--%>
